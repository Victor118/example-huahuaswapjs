...
exports.CodeInfoResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.CodeInfoResponse.typeUrl || typeof o.codeId === "bigint" && typeof o.creator === "string" && (o.dataHash instanceof Uint8Array || typeof o.dataHash === "string") && types_1.AccessConfig.is(o.instantiatePermission));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.CodeInfoResponse.typeUrl || typeof o.code_id === "bigint" && typeof o.creator === "string" && (o.data_hash instanceof Uint8Array || typeof o.data_hash === "string") && types_1.AccessConfig.isSDK(o.instantiate_permission));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.CodeInfoResponse.typeUrl || typeof o.code_id === "bigint" && typeof o.creator === "string" && (o.data_hash instanceof Uint8Array || typeof o.data_hash === "string") && types_1.AccessConfig.isAmino(o.instantiate_permission));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.codeId !== BigInt(0)) {
            writer.uint32(8).uint64(message.codeId);
...
exports.QueryParamsResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryParamsResponse.typeUrl || types_1.Params.is(o.params));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryParamsResponse.typeUrl || types_1.Params.isSDK(o.params));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.QueryParamsResponse.typeUrl || types_1.Params.isAmino(o.params));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.QueryContractsByCreatorRequest = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryContractsByCreatorRequest.typeUrl || typeof o.creatorAddress === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryContractsByCreatorRequest.typeUrl || typeof o.creator_address === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.QueryContractsByCreatorRequest.typeUrl || typeof o.creator_address === "string");
    },
...
registry_1.GlobalDecoderRegistry.register(exports.QueryContractsByCreatorRequest.typeUrl, exports.QueryContractsByCreatorRequest);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.QueryContractsByCreatorRequest.aminoType, exports.QueryContractsByCreatorRequest.typeUrl);
...
exports.QueryContractsByCreatorResponse = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.QueryContractsByCreatorResponse.typeUrl || Array.isArray(o.contractAddresses) && (!o.contractAddresses.length || typeof o.contractAddresses[0] === "string"));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.QueryContractsByCreatorResponse.typeUrl || Array.isArray(o.contract_addresses) && (!o.contract_addresses.length || typeof o.contract_addresses[0] === "string"));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.QueryContractsByCreatorResponse.typeUrl || Array.isArray(o.contract_addresses) && (!o.contract_addresses.length || typeof o.contract_addresses[0] === "string"));
    },
...
registry_1.GlobalDecoderRegistry.register(exports.QueryContractsByCreatorResponse.typeUrl, exports.QueryContractsByCreatorResponse);
registry_1.GlobalDecoderRegistry.registerAminoProtoMapping(exports.QueryContractsByCreatorResponse.aminoType, exports.QueryContractsByCreatorResponse.typeUrl);
