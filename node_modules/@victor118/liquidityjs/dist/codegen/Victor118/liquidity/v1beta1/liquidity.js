...
exports.SwapMsgState = exports.WithdrawMsgState = exports.DepositMsgState = exports.PoolBatch = exports.PoolMetadata = exports.Pool = exports.Params = exports.PoolType = void 0;
...
exports.PoolType = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.PoolType.typeUrl || typeof o.id === "number" && typeof o.name === "string" && typeof o.minReserveCoinNum === "number" && typeof o.maxReserveCoinNum === "number" && typeof o.description === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.PoolType.typeUrl || typeof o.id === "number" && typeof o.name === "string" && typeof o.min_reserve_coin_num === "number" && typeof o.max_reserve_coin_num === "number" && typeof o.description === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.PoolType.typeUrl || typeof o.id === "number" && typeof o.name === "string" && typeof o.min_reserve_coin_num === "number" && typeof o.max_reserve_coin_num === "number" && typeof o.description === "string");
    },
...
registry_1.GlobalDecoderRegistry.register(exports.PoolType.typeUrl, exports.PoolType);
...
exports.Params = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.Params.typeUrl || Array.isArray(o.poolTypes) && (!o.poolTypes.length || exports.PoolType.is(o.poolTypes[0])) && typeof o.minInitDepositAmount === "string" && typeof o.initPoolCoinMintAmount === "string" && typeof o.maxReserveCoinAmount === "string" && Array.isArray(o.poolCreationFee) && (!o.poolCreationFee.length || coin_1.Coin.is(o.poolCreationFee[0])) && typeof o.swapFeeRate === "string" && typeof o.withdrawFeeRate === "string" && typeof o.maxOrderAmountRatio === "string" && typeof o.unitBatchHeight === "number" && typeof o.circuitBreakerEnabled === "boolean");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.Params.typeUrl || Array.isArray(o.pool_types) && (!o.pool_types.length || exports.PoolType.isSDK(o.pool_types[0])) && typeof o.min_init_deposit_amount === "string" && typeof o.init_pool_coin_mint_amount === "string" && typeof o.max_reserve_coin_amount === "string" && Array.isArray(o.pool_creation_fee) && (!o.pool_creation_fee.length || coin_1.Coin.isSDK(o.pool_creation_fee[0])) && typeof o.swap_fee_rate === "string" && typeof o.withdraw_fee_rate === "string" && typeof o.max_order_amount_ratio === "string" && typeof o.unit_batch_height === "number" && typeof o.circuit_breaker_enabled === "boolean");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.Params.typeUrl || Array.isArray(o.pool_types) && (!o.pool_types.length || exports.PoolType.isAmino(o.pool_types[0])) && typeof o.min_init_deposit_amount === "string" && typeof o.init_pool_coin_mint_amount === "string" && typeof o.max_reserve_coin_amount === "string" && Array.isArray(o.pool_creation_fee) && (!o.pool_creation_fee.length || coin_1.Coin.isAmino(o.pool_creation_fee[0])) && typeof o.swap_fee_rate === "string" && typeof o.withdraw_fee_rate === "string" && typeof o.max_order_amount_ratio === "string" && typeof o.unit_batch_height === "number" && typeof o.circuit_breaker_enabled === "boolean");
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
exports.Pool = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.Pool.typeUrl || typeof o.id === "bigint" && typeof o.typeId === "number" && Array.isArray(o.reserveCoinDenoms) && (!o.reserveCoinDenoms.length || typeof o.reserveCoinDenoms[0] === "string") && typeof o.reserveAccountAddress === "string" && typeof o.poolCoinDenom === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.Pool.typeUrl || typeof o.id === "bigint" && typeof o.type_id === "number" && Array.isArray(o.reserve_coin_denoms) && (!o.reserve_coin_denoms.length || typeof o.reserve_coin_denoms[0] === "string") && typeof o.reserve_account_address === "string" && typeof o.pool_coin_denom === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.Pool.typeUrl || typeof o.id === "bigint" && typeof o.type_id === "number" && Array.isArray(o.reserve_coin_denoms) && (!o.reserve_coin_denoms.length || typeof o.reserve_coin_denoms[0] === "string") && typeof o.reserve_account_address === "string" && typeof o.pool_coin_denom === "string");
    },
...
exports.PoolMetadata = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.PoolMetadata.typeUrl || typeof o.poolId === "bigint" && coin_1.Coin.is(o.poolCoinTotalSupply) && Array.isArray(o.reserveCoins) && (!o.reserveCoins.length || coin_1.Coin.is(o.reserveCoins[0])));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.PoolMetadata.typeUrl || typeof o.pool_id === "bigint" && coin_1.Coin.isSDK(o.pool_coin_total_supply) && Array.isArray(o.reserve_coins) && (!o.reserve_coins.length || coin_1.Coin.isSDK(o.reserve_coins[0])));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.PoolMetadata.typeUrl || typeof o.pool_id === "bigint" && coin_1.Coin.isAmino(o.pool_coin_total_supply) && Array.isArray(o.reserve_coins) && (!o.reserve_coins.length || coin_1.Coin.isAmino(o.reserve_coins[0])));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
...
registry_1.GlobalDecoderRegistry.register(exports.PoolMetadata.typeUrl, exports.PoolMetadata);
...
exports.PoolBatch = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.PoolBatch.typeUrl || typeof o.poolId === "bigint" && typeof o.index === "bigint" && typeof o.beginHeight === "bigint" && typeof o.depositMsgIndex === "bigint" && typeof o.withdrawMsgIndex === "bigint" && typeof o.swapMsgIndex === "bigint" && typeof o.executed === "boolean");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.PoolBatch.typeUrl || typeof o.pool_id === "bigint" && typeof o.index === "bigint" && typeof o.begin_height === "bigint" && typeof o.deposit_msg_index === "bigint" && typeof o.withdraw_msg_index === "bigint" && typeof o.swap_msg_index === "bigint" && typeof o.executed === "boolean");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.PoolBatch.typeUrl || typeof o.pool_id === "bigint" && typeof o.index === "bigint" && typeof o.begin_height === "bigint" && typeof o.deposit_msg_index === "bigint" && typeof o.withdraw_msg_index === "bigint" && typeof o.swap_msg_index === "bigint" && typeof o.executed === "boolean");
    },
...
registry_1.GlobalDecoderRegistry.register(exports.PoolBatch.typeUrl, exports.PoolBatch);
...
exports.DepositMsgState = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.DepositMsgState.typeUrl || typeof o.msgHeight === "bigint" && typeof o.msgIndex === "bigint" && typeof o.executed === "boolean" && typeof o.succeeded === "boolean" && typeof o.toBeDeleted === "boolean");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.DepositMsgState.typeUrl || typeof o.msg_height === "bigint" && typeof o.msg_index === "bigint" && typeof o.executed === "boolean" && typeof o.succeeded === "boolean" && typeof o.to_be_deleted === "boolean");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.DepositMsgState.typeUrl || typeof o.msg_height === "bigint" && typeof o.msg_index === "bigint" && typeof o.executed === "boolean" && typeof o.succeeded === "boolean" && typeof o.to_be_deleted === "boolean");
    },
...
registry_1.GlobalDecoderRegistry.register(exports.DepositMsgState.typeUrl, exports.DepositMsgState);
...
exports.WithdrawMsgState = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.WithdrawMsgState.typeUrl || typeof o.msgHeight === "bigint" && typeof o.msgIndex === "bigint" && typeof o.executed === "boolean" && typeof o.succeeded === "boolean" && typeof o.toBeDeleted === "boolean");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.WithdrawMsgState.typeUrl || typeof o.msg_height === "bigint" && typeof o.msg_index === "bigint" && typeof o.executed === "boolean" && typeof o.succeeded === "boolean" && typeof o.to_be_deleted === "boolean");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.WithdrawMsgState.typeUrl || typeof o.msg_height === "bigint" && typeof o.msg_index === "bigint" && typeof o.executed === "boolean" && typeof o.succeeded === "boolean" && typeof o.to_be_deleted === "boolean");
    },
...
registry_1.GlobalDecoderRegistry.register(exports.WithdrawMsgState.typeUrl, exports.WithdrawMsgState);
...
exports.SwapMsgState = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.SwapMsgState.typeUrl || typeof o.msgHeight === "bigint" && typeof o.msgIndex === "bigint" && typeof o.executed === "boolean" && typeof o.succeeded === "boolean" && typeof o.toBeDeleted === "boolean" && typeof o.orderExpiryHeight === "bigint" && coin_1.Coin.is(o.exchangedOfferCoin) && coin_1.Coin.is(o.remainingOfferCoin) && coin_1.Coin.is(o.reservedOfferCoinFee));
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.SwapMsgState.typeUrl || typeof o.msg_height === "bigint" && typeof o.msg_index === "bigint" && typeof o.executed === "boolean" && typeof o.succeeded === "boolean" && typeof o.to_be_deleted === "boolean" && typeof o.order_expiry_height === "bigint" && coin_1.Coin.isSDK(o.exchanged_offer_coin) && coin_1.Coin.isSDK(o.remaining_offer_coin) && coin_1.Coin.isSDK(o.reserved_offer_coin_fee));
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.SwapMsgState.typeUrl || typeof o.msg_height === "bigint" && typeof o.msg_index === "bigint" && typeof o.executed === "boolean" && typeof o.succeeded === "boolean" && typeof o.to_be_deleted === "boolean" && typeof o.order_expiry_height === "bigint" && coin_1.Coin.isAmino(o.exchanged_offer_coin) && coin_1.Coin.isAmino(o.remaining_offer_coin) && coin_1.Coin.isAmino(o.reserved_offer_coin_fee));
    },
    encode(message, writer = binary_1.BinaryWriter.create()) {
        if (message.msgHeight !== BigInt(0)) {
            writer.uint32(8).int64(message.msgHeight);
...
registry_1.GlobalDecoderRegistry.register(exports.SwapMsgState.typeUrl, exports.SwapMsgState);
